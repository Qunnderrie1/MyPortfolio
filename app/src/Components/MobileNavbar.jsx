...
const MobileNavbar = ({ open }) => {
  ...
  return (
    <div className="">
      ...
      <div
        className={`animate-[moveMobileNav_0.3s_ease-in-out] h-screen w-screen flex justify-center items-center bg-black z-2 absolute top-0 p-0 m-0 ${
      ...
      >
        <div className="flex flex-col justify-center items-center  gap-10">
          <a
            ...
            className="animate-[moveMobileMenuText_1s_ease-in-out] text-[#f2fb00] font-bold  text-xl"
            href="#home"
          >
            HOME
          </a>
