    ...
    <div className="container relative  mt-40 ">
      ...
      <div className="flex justify-between max-sm:text-center max-xl:justify-center ">
        <div className="text-left px-10 max-xl:text-center max-xl:px-0">
          <p className="  text-left text-xl text-white max-xl:text-center">
            Hello!
          </p>
          <h1 className="text-8xl text-white font-bold max-xl:text-6xl">
            I AM A{" "}
            <span className="text-[#f2fb00] block max-xl:text-6xl">
              WEB DEVELOPER
            </span>
          </h1>
          <p className="text-white text-xl mt-2 max-md:text-base  max-sm:text-base">
          ...
          <div className="flex  gap-10 mt-14 max-xl:flex-col max-lg:py-4 xl:absolute  ">
            <a href="/Qunnderrie_Software_Engineer_2024.pdf" download>
              <button className="bg-[#f2fb00] rounded font-bold py-2 max-lg:w-40 m-auto sm:w-40 ">
                RESUME CV <FontAwesomeIcon icon={faArrowRight} />
              </button>
            </a>
            <a href="#portfolio" className=" text-[#f2fb00] text-xl">
